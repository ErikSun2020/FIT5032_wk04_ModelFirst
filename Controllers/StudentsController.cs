...
using FIT5032_wk04_ModelFirst.Models;

namespace FIT5032_wk04_ModelFirst.Controllers
{
    public class StudentsController : Controller
    {
        private FIT5032_wk04_ModelContainer db = new FIT5032_wk04_ModelContainer();
